                ...
                <div class="p-4">
                  ...
                  <div class="mt-4 pt-2">
                    <a href="" class="btn btn-primary w-100"
                      >See All Balances <i class="mdi mdi-arrow-right ms-1"></i
                    ></a>
                  </div>
                </div>
              </div>
                ...
                <div class="dropdown">
                  ...
                  >
                    ...
                    <span class="fw-medium"
                      >World<i class="mdi mdi-chevron-down ms-1"></i
                    ></span>
                  </a>
          ...
          <div class="card-body px-0">
            <div class="px-3" data-simplebar="" style="max-height: 386px">
              <div class="d-flex align-items-center pb-4">
                ...
                <div class="flex-grow-1">
                  <h5 class="font-size-15 mb-1">
                    <a href="" class="text-dark">Randy Matthews</a>
                  </h5>
              ...
              <div class="d-flex align-items-center pb-4">
                ...
                <div class="flex-grow-1">
                  <h5 class="font-size-15 mb-1">
                    <a href="" class="text-dark">Vernon Wood</a>
                  </h5>
              ...
              <div class="d-flex align-items-center pb-4">
                ...
                <div class="flex-grow-1">
                  <h5 class="font-size-15 mb-1">
                    <a href="" class="text-dark">Howard Rhoades</a>
                  </h5>
              ...
              <div class="d-flex align-items-center pb-4">
                ...
                <div class="flex-grow-1">
                  <h5 class="font-size-15 mb-1">
                    <a href="" class="text-dark">Arthur Zurcher</a>
                  </h5>
              ...
              <div class="d-flex align-items-center pb-4">
                ...
                <div class="flex-grow-1">
                  <h5 class="font-size-15 mb-1">
                    <a href="" class="text-dark">Angela Palmer</a>
                  </h5>
              ...
              <div class="d-flex align-items-center pb-3">
                ...
                <div class="flex-grow-1">
                  <h5 class="font-size-15 mb-1">
                    <a href="" class="text-dark">Dorothy Wimson</a>
                  </h5>
              ...
              <table class="table align-middle table-nowrap">
                <tbody>
                  <tr>
                    ...
                    <td>
                      <p class="mb-1">
                        <a href="" class="text-dark">Available</a>
                      </p>
                  ...
                  <tr>
                    ...
                    <td>
                      <div>
                        <h5 class="font-size-15">
                          <a href="" class="text-dark">Light blue T-shirt</a>
                        </h5>
                    ...
                    <td>
                      <p class="mb-1">
                        <a href="" class="text-dark">Out Of Stock</a>
                      </p>
                  ...
                  <tr>
                    ...
                    <td>
                      <div>
                        <h5 class="font-size-15">
                          <a href="" class="text-dark">Black Color T-shirt</a>
                        </h5>
                  ...
                  <tr>
                    ...
                    <td>
                      <div>
                        <h5 class="font-size-15">
                          <a href="" class="text-dark"></a>Hoodie (Blue)
                        </h5>
                  ...
                  <tr>
                    ...
                    <td>
                      <div>
                        <h5 class="font-size-15">
                          <a href="" class="text-dark"></a>Half sleeve T-Shirt
                        </h5>
                  ...
                  <tr>
                    ...
                    <td>
                      <div>
                        <h5 class="font-size-15">
                          <a href="" class="text-dark"></a>Green color T-shirt
                        </h5>
